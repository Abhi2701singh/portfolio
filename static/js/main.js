...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Circular Progress Bar for Minimal Skills ---
    function animateMinimalCircleProgress() {
        document.querySelectorAll('.circle-progress-minimal').forEach(function(circle) {
